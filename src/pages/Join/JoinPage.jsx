...
export default function JoinPage() {
  ...
  const handleJoin = async () => {
    ...
    if (balance < 0.5) {
      logger.warn('JoinPage: insufficient balance for commission', { balance, required: 0.5 })
      return
    }
...
function SummaryFooter({ selectedCount, totalTon, roomBetAmount, betValidation, onJoin, balance }) {
  const insufficientBalance = balance < 0.5
  const disabled = selectedCount === 0 || !betValidation.isValid || insufficientBalance
